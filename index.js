import MediumEditor from "./node_modules/medium-editor/dist/js/medium-editor.min.js";

import icon from "./images/icon.png";
import icon_128 from "./images/icon_128.png";
  ...
  getStorage(function (data) {
    ...
    function saveEditorContent() {
      ...
      if (data.length >= QUOTA_BYTES_PER_ITEM) {
        ...
        alert(
          "Storage quota exceeded, please try to create a new item or remove unused content"
        );
        return;
      }
